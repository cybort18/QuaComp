...
def export_comparison_to_markdown(
    ...
    md_lines = [
        ...
        f"| **Capacity Metric (C = 2ⁿ)** | {summary['capacity_metric_base']:,.0f} | {summary['capacity_metric_target']:,.0f} | **{summary['capacity_ratio']:.2f}x Capacity** |",
    ...
    md_lines.append("*(Report automatically generated by QuaComp Relative Benchmark Comparator v1.0.0)*\n")
